...
public class DashboardFragment extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        //DrankUp Button
        drankUp = v.findViewById(R.id.drankUp);
        ...
        View.OnClickListener drankUpListener = new View.OnClickListener() {

            @Override
            public void onClick(View v) {
//                Toast.makeText(getActivity(), "HELLO BUTTON PRESSED", Toast.LENGTH_SHORT).show();
                  mWaveLoadingView.setProgressValue(100);
            }
        };
        drankUp.setOnClickListener(drankUpListener);

        // Get the Water Requirement
        WaterRequirementComputation wrc = new WaterRequirementComputation();
        user_waterRequirement = wrc.waterRequirement(user_weight);
        mWaveLoadingView.setCenterTitle("Your goal is " + user_waterRequirement +"ml");
        return  v;




//        user_waterRequirement = wrc.waterRequirementz(user_weight);
...
//    public void onClick(View v) {
//
//        Toast.makeText(DashboardFragment.this, "Drank Up Button Pressed", Toast.LENGTH_SHORT).show();
//
    }
}
